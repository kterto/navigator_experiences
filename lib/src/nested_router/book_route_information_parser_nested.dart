...
class BookRouteInformationParserNested
    extends RouteInformationParser<BookRoutePathNested> {
  @override
  Future<BookRoutePathNested> parseRouteInformation(
  ...
  @override
  RouteInformation restoreRouteInformation(BookRoutePathNested configuration) {
